...
:category: labs
:tags: rdf, integrations, extensions, data import, data export, ontology
:neo4j-versions: 3.5, 4.0

image::nsmntx-logo.png[float=right,width=500]
...
image::nsmntx-block-diagram.png[float=right,width=200]
