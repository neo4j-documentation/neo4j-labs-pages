...
image::{img}/neo4j-loves-confluent.png[width=500]
...
image::{img}/connect-hub-neo4j-sink.png[link="https://www.confluent.io/connector/kafka-connect-neo4j-sink/"]
...
image::{img}/kafka-source-flow.png[link={docs}/#_neo4j_streams_producer, width=800]
...
image::{img}/kafka-sink-flow.png[link={docs}/#_neo4j_streams_consumer]
