...
:docs: http://neo4j-labs.github.io/neosemantics/

include::header.adoc[]

image::http://neo4j-labs.github.io/neosemantics/docs/img/nsmntx-logo.png[float=right,width=500]
...
image::http://neo4j-labs.github.io/neosemantics/docs/img/nsmntx-block-diagram.png[float=right,width=400]
...
| icon:book[] Docs | http://neo4j-labs.github.io/neosemantics/
// | icon:book[] Article | 
